                               ...
                               <div class="formule">
                                    <div class="les-input" id="Medecin-A" style="display: none;">
                                        <select class="input" name="Medecin-A" id="" placeholder="" style=" width: 217px;">
                                            ...
                                            <o ption value="Généraliste secteur 1">chirurgien dentiste</option>
                                            <option value="Généraliste secteur 2">stomatologue secteur 1</option>
                                            <option value="Spécialiste secteur 1">stomatologue secteur 2</option>
